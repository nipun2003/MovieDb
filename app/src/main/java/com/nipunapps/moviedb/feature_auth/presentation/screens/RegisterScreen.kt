...
import com.nipunapps.moviedb.feature_auth.presentation.view_models.RegisterViewModel
...
fun RegisterScreen(
    ...
    val email = registerViewModel.emailState.collectAsState().value
    val password = registerViewModel.passwordState.collectAsState().value
    Scaffold(modifier = Modifier.fillMaxSize()) {
        Box(
            ...
            Column(
                ...
                CustomOutlinedButton(text = R.string.sign_up) {
                ...
                Spacer(modifier = Modifier.height(SpacingXXL))
                AlternateAuthOption(
                    disabledText = R.string.have_account,
                    clickableText = R.string.login
                )
            }
        }
    }
